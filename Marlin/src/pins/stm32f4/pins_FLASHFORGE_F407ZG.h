...
#include "env_validate.h"
  ...
  #error "FlashForge F407ZG supports up to 2 hotends / E-steppers."
#endif

#define BOARD_INFO_NAME      "FlashForge F407ZG"
#define BOARD_WEBSITE_URL    "flashforge.com"
...
// /* swap it for better visual observ */
