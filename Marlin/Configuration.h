...
#define STRING_CONFIG_H_AUTHOR "(tracedgod, FlashForge Dreamer)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_FLASHFORGE_F407ZG
#endif
...
#define CUSTOM_MACHINE_NAME "FlashForge Dreamer"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 88.909720, 88.909720, 400.0, 96.275202 }
...
//
// 480x320, 3.5", FSMC Stock Display from FlashForge Dreamer, etc.
//
#define FLASHFORGE_TFT
